...
- (void)viewDidLoad {
    [super viewDidLoad];
    self.view.backgroundColor =[UIColor redColor];//COLOR_YELLOW
...
-(void)setUpcategoriesTableView
{
    self.categoriesTableView = (
    {
        ...
        tabView.backgroundColor = [UIColor yellowColor];//COLOR_BG
    ...
    [self.categoriesTableView mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.width.mas_equalTo(self.view).with.multipliedBy(0.25);
    }];
}
